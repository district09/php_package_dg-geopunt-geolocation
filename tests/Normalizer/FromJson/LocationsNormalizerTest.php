...
/**
 * @covers \DigipolisGent\Geopunt\Geolocation\Normalizer\FromJson\LocationsNormalizer
 */
class LocationsNormalizerTest extends TestCase
{
    /**
    ...
    private $json = <<<EOT
{
    "LocationResult":[
        ...
        },
        {
            ...
            "Housenumber": "2",
            "ID": 1235,
            "FormattedAddress": "Trambergstraat 2, 3120 Zonhoven",
            "Location": {
                "Lat_WGS84": 50.991974017459327,
                "Lon_WGS84": 5.3517046535166282,
                "X_Lambert72": 219009.14,
