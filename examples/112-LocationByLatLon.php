...
printTitle('Get a list of locations by reverse latitude-longitude lookup.');
...
$locations = $service->locationsByLatitudeLongitude($locationLat, $locationLon, $locationLimit);
